    ...
    <div class="w-full h-auto aspect-square rounded-xl overflow-hidden relative">
      ...
      <button class="absolute top-4 right-4">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false"
          ...
          <path class="stroke-bgColorPrimary" d="M16 28c7-4.73 14-10 14-17a6.98 6.98 0 0 0-7-7c-1.8 0-3.58.68-4.95 2.05L16 8.1l-2.05-2.05a6.98 6.98 0 0 0-9.9 0A6.98 6.98 0 0 0 2 11c0 7 7 12.27 14 17z"></path>
        </svg>
      </button>
    </div>
      ...
      <div class="flex items-start justify-center">
        ...
        <div class="flex gap-2 items-center justify-center">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false"
            ...
            <path class="stroke-emerald-50" fill-rule="evenodd"
...
import type {Location} from "@/modules/lists/models/Location";
